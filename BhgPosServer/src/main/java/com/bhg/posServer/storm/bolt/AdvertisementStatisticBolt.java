...
public class AdvertisementStatisticBolt extends AbstractVisitStatisticBolt {
	...
	protected String redisUVClickField(Tuple input) {
		return redisUVTime(input) + "#" + input.getLongByField(StormConstant.BOLT_FIELD_ADVERTISEMENT_UUID);
	}
